...
public:
    Pin() {
         ...
         * -1 - Первый рабочий еще не осмотрел булавку
         * 0 - Первый рабочий осмотрел булавку - она кривая(шанс кривой булавки = 1 - good_chance)
         * 1 - Первый рабочий осмотрел булавку - она не кривая(шанс не кривой булавки = good_chance)
         * 2 - Булавка заточена помощником(после успешного осмотра первым рабочим)
         * 3 - Булавка прошла контроль качества третьим рабочим(шанс пройти осмотр = inspected_chance)
         * -3 - Булавка не прошла контроль качества третьим рабочим(шанс не пройти осмотр = 1 - inspected_chance)*/
        condition_ = -1;
    }
